module.exports = [
    ...
    {
      captainName: "Stewie Griffin",
      title: "Family Guy",
      post: "When the world is mine, your death should quick and painless",
      mistakesWereMadeToday: true,
      daysSinceLastCrisis: 20,
    },
    {
      captainName: "Peter Griffin",
      title: "Family Guy",
      post: "Now I may be an idiot, but there's one thing I am not sir, and that sir, is an idiot. ",
      mistakesWereMadeToday: true,
      daysSinceLastCrisis: 0,
    },
    {
      captainName: "Glenn Quagmire",
      title: "Family Guy",
      post: "I can be Giggity. I can be Goo.",
      mistakesWereMadeToday: true,
      daysSinceLastCrisis: 5,
    },
  ];